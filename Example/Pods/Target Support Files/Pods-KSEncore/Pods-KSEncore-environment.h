...
// KSEncore
#define COCOAPODS_POD_AVAILABLE_KSEncore
#define COCOAPODS_VERSION_MAJOR_KSEncore 1
#define COCOAPODS_VERSION_MINOR_KSEncore 0
#define COCOAPODS_VERSION_PATCH_KSEncore 2
